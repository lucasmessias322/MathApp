...
import { AditionphasesList, MutiplicationphasesList } from "../../components/AditAndSubtrComponents/aditAndSubtrphasesList";
import AditAndSubtrComponents from "../../components/AditAndSubtrComponents";

export default function MutiplicationGame() {
  ...
  return (
    <AditAndSubtrComponents
      ...
      RedirectLevelsUrl="/multiplicationlevels"
